...
title "DB-CONFIGURING INSTALLER"
echo Configuring environment for DB configuration script...
echo ------------------------------------------------------
...
call pip install --no-index -U --force-reinstall --find-links=dependencies -r .\requirements.txt
